...
import { Plus, DollarSign, TrendingUp, TrendingDown, ShoppingBag, Loader2, ArrowUpRight, ArrowDownRight } from 'lucide-react';
...
export const FinanceList: React.FC = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const data = await FarmService.getTransactions();
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm">Track farm income, expenses, and sales.</p>
        </div>
